...
impl CellType {
    ...
    pub fn type_id(&self) -> TypeId {
        ...
        match self {
            ...
            Handle8 => TypeId::of::<ids::Handle8>(),
            Handle16 => TypeId::of::<ids::Handle16>(),
            Handle32 => TypeId::of::<ids::Handle32>(),
            Handle64 => TypeId::of::<ids::Handle64>(),
            Handle128 => TypeId::of::<ids::Handle128>(),
            // Uuid => TypeId::of::<ids::Uuid>(),
            F32 => TypeId::of::<f32>(),
            F64 => TypeId::of::<f64>(),
            I8 => TypeId::of::<i8>(),
            U8 => TypeId::of::<u8>(),
    ...
    pub const fn size(&self) -> usize {
        ...
        match self {
            ...
            Handle8 => size_of::<ids::Handle8>(),
            Handle16 => size_of::<ids::Handle16>(),
            Handle32 => size_of::<ids::Handle32>(),
            Handle64 => size_of::<ids::Handle64>(),
            Handle128 => size_of::<ids::Handle128>(),
            // Uuid => size_of::<ids::Uuid>(),
            F32 => size_of::<f32>(),
            F64 => size_of::<f64>(),
            I8 => size_of::<i8>(),
            U8 => size_of::<u8>(),
    ...
    pub const fn alignment(&self) -> usize {
        ...
        match self {
            ...
            Handle8 => align_of::<ids::Handle8>(),
            Handle16 => align_of::<ids::Handle16>(),
            Handle32 => align_of::<ids::Handle32>(),
            Handle64 => align_of::<ids::Handle64>(),
            Handle128 => align_of::<ids::Handle128>(),
            // Uuid => align_of::<ids::Uuid>(),
            F32 => align_of::<f32>(),
            F64 => align_of::<f64>(),
            I8 => align_of::<i8>(),
            U8 => align_of::<u8>(),
