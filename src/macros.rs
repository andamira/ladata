...
// TEMP OK
// TODO: make an IMPROVED version that supportst optional args
//
...
// - receive the args as a tt
//
// /// call a custom method (optional args) on all provided variants.
// #[macro_export]
// #[doc(hidden)]
// macro_rules! __match_variants_method_args {
//     ( $self:ident, $method:ident( $( $args:tt ),*); ($( $variant:tt ),+) ) => {
//         match *$self {
//             $(
//                 $variant(ref v) => { v.$method($($args)*) },
//             )+
//         }
//     };
// }
