...
//!
//! # Unitary data: Data `Type*`|`Cell*`|`Bare*`
//!
...
pub mod bares {
    super::macros::reexport![mod_bares, crate::units::build; all_sizes];
}

/// Data *Cells* (the encapsulation of *data* plus *type*).
pub mod cells {
    super::macros::reexport![mod_cells, crate::units::build; all_sizes];
}

/// Data *Types* (just the *type* of the data).
pub mod types {
    super::macros::reexport![mod_types, crate::units::build; all_sizes];
}

/// Every unitary type, organized by size.
pub mod size {
    super::macros::reexport![mod_size, crate::units::build; all_sizes];
}
