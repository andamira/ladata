...
macro_rules! reexport {
    ...
    ($mod:ident, $path:path; all_sizes) => {
        use $crate::units::macros::reexport;
    ...
    (mod_size $path:path; $B:literal, $b:literal ) => {
        paste::paste!{
            ...
            pub mod [< b $b >] {
                $crate::units::macros::reexport![@CellType $path; size: $b; bit bitWith bitCopy bitCopyWith ];
                $crate::units::macros::reexport![@Bare $path; size: $b; bitCopy ];
            }
        }
    };
    ...
    (mod_cells $path:path; $B:literal, $b:literal ) => {
        paste::paste!{
            $crate::units::macros::reexport![@Cell $path; size: $b; bit bitWith bitCopy bitCopyWith ];
        }
    };
    // `::types::` reexports, single size
    (mod_types $path:path; $B:literal, $b:literal ) => {
        paste::paste!{
            $crate::units::macros::reexport![@Type $path; size: $b; bit bitWith bitCopy bitCopyWith ];
        }
    };
    ...
    (mod_bares $path:path; $B:literal, $b:literal ) => {
        paste::paste!{
            // WIP
            $crate::units::macros::reexport![@Bare $path; size: $b; bitCopy ];
            // $crate::units::macros::reexport![@Bare $path; size: $b; bit bitWith bitCopy bitCopyWith ];
        }
    };
    ...
    (@Cell $path:path; size: $size:literal; $( $suf:ident )+ ) => {
        $crate::units::macros::reexport![@ $path; DataCell; size: $size ; $( $suf )+ ];
    };

    // re-exports DataType
    (@Type $path:path; size: $size:literal; $( $suf:ident )+ ) => {
        $crate::units::macros::reexport![@ $path; DataType; size: $size ; $( $suf )+ ];
    };

    // re-exports DataBare
    (@Bare $path:path; size: $size:literal; $( $suf:ident )+ ) => {
        $crate::units::macros::reexport![@ $path; DataBare; size: $size ; $( $suf )+ ];
    };
